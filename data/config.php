...
return [
    ...
    'app_version' => 'v1.6.9', // 현재 설치된 앱 버전
    'powered_by' => '정재현', // 관리자 화면 하단에 표시할 개발자/운영자 이름
    'timezone' => 'Asia/Seoul', // 날짜와 시간을 계산할 기본 시간대

    // 저장소 및 업데이트 설정
    'repository_url' => 'https://github.com/jaehyun1122/self-study-attendance', // 프로젝트 공개 저장소 주소
    'update_repository' => 'jaehyun1122/self-study-attendance', // 업데이트 확인에 사용할 GitHub owner/repo
